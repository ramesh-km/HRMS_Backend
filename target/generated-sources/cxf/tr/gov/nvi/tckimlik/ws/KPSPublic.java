 ...
 * 2023-04-11T17:00:34.829+05:30
 * Generated source version: 3.4.3
 *
 */
@WebServiceClient(name = "KPSPublic",
                  wsdlLocation = "file:/home/ramesh/tmp/HRMS_Backend/src/main/resources/Mernis.wsdl",
...
public class KPSPublic extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/ramesh/tmp/HRMS_Backend/src/main/resources/Mernis.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(KPSPublic.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/ramesh/tmp/HRMS_Backend/src/main/resources/Mernis.wsdl");
        }
        WSDL_LOCATION = url;
    }
